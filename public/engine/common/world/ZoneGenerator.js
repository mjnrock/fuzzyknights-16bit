...
class RandomAverage {
	...
	GetZone(...terrainRanges) {
		...
		zone.Terrain.ForEach((pos, terrain, em) => {
			ZoneGenerator.FuzzyKnights.Common.Component.Mutator.Worlds.SetHeading(terrain, pos.X, pos.Y, 0);
			ZoneGenerator.FuzzyKnights.Common.Component.Mutator.Worlds.SetZone(terrain, zone);
		});
