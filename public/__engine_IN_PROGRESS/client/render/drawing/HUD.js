class HUD {
	constructor(fk, canvas) {
		...
		this.Helper = {
			Width: this.FuzzyKnights.Common.Game.Settings.View.Tile.Width,
			Height: this.FuzzyKnights.Common.Game.Settings.View.Tile.Height,
			Target: this.FuzzyKnights.Common.Game.Settings.View.Tile.Target,
	...
	DrawResourceBars(entity) {
		...
		let pos = this.FuzzyKnights.Common.Component.Mutator.Maps.GetPosition(entity),
			health = this.FuzzyKnights.Common.Component.Mutator.Resources.GetHealth(entity),
			mana = this.FuzzyKnights.Common.Component.Mutator.Resources.GetMana(entity);
	...
	DrawResourceBar(ctx, res, x, y) {
		...
		if(res.Type === this.FuzzyKnights.Common.Component.Enum.ResourceType.HEALTH) {
		...
		} else if(res.Type === this.FuzzyKnights.Common.Component.Enum.ResourceType.MANA) {
