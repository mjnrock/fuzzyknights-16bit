...
class Canvas {
	...
	DrawTile(image, x, y, sx = 0, sy = 0) {
		let tx = x * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width,
			ty = y * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height;
		...
		this.DrawImage(
			image,
			sx * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width,
			sy * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height,
			Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width,
			Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height,
	...
	DrawColoredTile(image, x, y, color = null, sx = 0, sy = 0) {
		x = x * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width;
		y = y * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height;
		
		this.DrawImage(image, sx * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width, sy * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height, Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width, Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height, x, y, Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width, Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height);
	...
	DrawFitToTile(image, tx, ty, sx = 0, sy = 0) {
		let x = tx * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width,
			y = ty * Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height;
	...
	ColorizeTile(x, y, color = "rgb(54, 132, 54)") {
		...
		this.Context.fillRect(x, y, Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Width, Canvas.FuzzyKnights.Common.Game.Settings.View.Tile.Height);
