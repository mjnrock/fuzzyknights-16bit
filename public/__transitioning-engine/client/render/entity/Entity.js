...
class Entity {
	...
	constructor(fk, entity, filename, onload = null) {
		...
		this.Canvas.SetWidth(this.FuzzyKnights.Common.Game.Settings.View.Tile.Width).SetHeight(this.FuzzyKnights.Common.Game.Settings.View.Tile.Height);
	...
	GetTileCoordinates() {
		let rot = this.FuzzyKnights.Common.Component.Mutator.Worlds.GetAngle(this.Entity) || 0,
			tx = rot.Theta / 45 || 0,
			ty = 0;
